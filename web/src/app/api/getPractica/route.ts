// src/app/api/getPractica/route.ts
...
export async function GET(request: Request) {
  try {
    ...
    // Obtener las últimas 10 prácticas dentro del rango, ordenadas de forma descendente por ID
    ...
    if (practicas.length === 0) {
      return NextResponse.json({
        message: 'No se encontraron más prácticas',
        practicas: [],
      });
    }
